...
include './config/sidebar.php';?>  
  ...
  <div class="row">
    ...
    <div class="col-md-2">
      ...
      <button type="submit" id="submit" name="submit" 
      class="btn btn-primary btn-sm btn-flat btn-block";  onclick="window.print()" onmouseover="this.style.color='#12c736';" onmouseout="this.style.color='white';"> print </button>
